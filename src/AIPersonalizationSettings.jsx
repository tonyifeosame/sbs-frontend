  ...
  return (
    <div className="bg-white rounded-lg shadow-md">
      <div className="p-6 border-b flex items-center">
        ...
        <h1 className="text-xl font-bold text-gray-800">AI Personalization</h1>
      </div>

      <div className="p-8">
        <p className="text-sm text-gray-600 mb-4">Signed in as <span className="font-semibold">{user?.username || '—'}</span></p>
        <p className="text-gray-600">Controls for adjusting AI-driven recommendations will go here.</p>
      </div>
    </div>
  );
};
